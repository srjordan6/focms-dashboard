...
## [0.2.2] - 2026-06-03
   ...
   ### Changed
   - Version bump only. End-to-end validation of the GitHub → Git Updater → WordPress auto-update pipeline established in Phase 0.

   ### Migration notes
   - No functional code changes between v0.2.1 and v0.2.2
   - This release exists solely to verify that the auto-update mechanism works end-to-end
   - After this release, all future updates should flow through the same pipeline without manual intervention
